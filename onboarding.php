                ...
                <div class="">
                	<div style="text-align: center; margin-top:10vh">
                		<div class="form-group" style="text-align: center;">
                            <!-- <label>Email</label> -->
                            <img src="" id="logo_imgg" style="max-width: 100px; width: 17% !important;"><br>
                        </div>
                    ...
                    <div class="ant-card-body" style="">
                        ...
                        <div id="login_dv" style="display: none; margin-top: 50px;">
                            <div class="form-group">
                                <!-- <label>Email</label> -->
                                <input style="width: 50% ;margin-left: auto; margin-right: auto;" type="text" class="form-control required login_fms" placeholder="Whats your store name?" id="store_name" autocomplete="off" required>
                            </div>

                            <div class="form-group">
                                <!-- <label>Email</label> -->
                                <input style="width: 50% ;margin-left: auto; margin-right: auto;" type="text" class="form-control required login_fms" placeholder="Store Location" id="store_location" autocomplete="off" required>
                            </div>

                            <div class="form-group">
                                <!-- <label>Email</label> -->
                                <textarea style="width: 50% ;margin-left: auto; margin-right: auto;" type="text" class="form-control required login_fms" placeholder="Description" id="desc" autocomplete="off" required></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-12" style="text-align: center;">
                                        ...
                                        <button style="width: 50% ;margin-left: auto; margin-right: auto;" class="btn btn-success btn-block login_btn" style="border: 0px;" id="store_cont">Continue</button>
                         ...
                         <div id="category_dv" style="display: none ;">
                            
							<p style="text-align: center;" class="cat_p">Create a category for products</p>
                            <div class="form-group">
                                <!-- <label>Email</label> -->
                                <input style="width: 50%;margin-left: auto; margin-right: auto;" type="text" class="form-control required login_fms" placeholder="E.g Beverages" id="cat_name" autocomplete="off">
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-12" style="text-align: center;">
                                        <div id="error-msg" style="text-align: center; color: red;"></div>
                                        <button style="width: 50% ;margin-left: auto; margin-right: auto;" class="btn btn-success btn-block login_btn" style="border: 0px;" id="cat_cont">Continue</button>
                                        <i class="fa fa-spinner fa-spin fa-fw fa-3x" style="display: none; color: grey; text-align: center;" id="loader_cat"></i>
                                    </div>
                                </div>
                            </div>
                         ...
                         <div id="unit_dv" style="display: none ;">
                            
							<p style="text-align: center; margin-bottom: 10px;">Create a unit of measurement
                            E.g kilogramss</p>
                            <div class="form-group">
                                <!-- <label>Email</label> -->
                                <input style="width: 50% ;margin-left: auto; margin-right: auto;" type="text" class="form-control required login_fms" placeholder="Unit Name" id="unit_name" autocomplete="off">
                            </div>

                            <div class="form-group">
                                <!-- <label>Email</label> -->
                                <input style="width: 50% ;margin-left: auto; margin-right: auto;" type="text" class="form-control required login_fms" placeholder="Unit Symbol" id="unit_symbol" autocomplete="off">
                            </div>

                         <!--  <div class="form-group">
                                <textarea style="width: 50% !important;margin-left: auto; margin-right: auto;" type="text" class="form-control required login_fms" placeholder="Description" id="unit_desc" autocomplete="off"></textarea>
                            </div>
 -->
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <div class="col-12" style="text-align: center;">
                                        <div id="error-msg" style="text-align: center; color: red;"></div>
                                        <button style="width: 50% ;margin-left: auto; margin-right: auto;" class="btn btn-success btn-block login_btn" style="border: 0px;" id="cont_unit">Continue</button>
                                        <i class="fa fa-spinner fa-spin fa-fw fa-3x" style="display: none; color: grey; text-align: center;" id="loader_lgn"></i>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group text-center">
                            ...
                            <div class="col-4"><a href="terms" class="text-muted">Terms</a></div> -->
                                ...
                                <div class="col-8">
                                    <a href="http://nahere.com" class="text-muted" style="position: fixed;bottom: 30px;left: 40%;">
                                        ©
                                        2022                                        NaHere!
                                    </a>
                                </div>
               ...
               <div class="ant-col-xs-24 ant-col-sm-12 ant-col-md-12 ant-col-lg-12 ant-col-xl-10">
                <div class="">
                    <div class="ant-card-body" style="padding:0px !important">
                          <div class="content d-none d-lg-block"  id="content" style="background-color: #04003d; background: url() no-repeat; background-size: cover;">
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.status == "200") {
                            ...
                            $("#content").css("background", "url(https://miro.medium.com/max/1400/1*ZCOyBJ7UpR2xpe9H2IXVSg.jpeg)");
