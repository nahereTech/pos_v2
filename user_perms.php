                                                ...
                                                <table style="table-layout: auto;">
                                                    ...
                                                    <thead class="ant-table-thead">
                                                        <tr>
                                                            ...
                                                            <th class="ant-table-cell" style="width: 30%"></th>
                                                            <th class="ant-table-cell" style="width: 30%">Profile</th>
                                                            <th class="ant-table-cell" style="width: 40%">Profile Permissions</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody class="ant-table-tbody" id="permData">
...
function fetch_warehouse_details(warehouse_id) {
    ...
    $.ajax({
        ...
        dataType: "json",
        cache: false,
        url: base_url + "/api/wms/get_warehouse_details",
        data: { warehouse_id: warehouse_id, company_id: company_id },
...
function delete_warehouse(warehouse_id) {
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: base_url + "/api/wms/delete_warehouse",
...
function add_user() {
    ...
    $.ajax({
        ...
        dataType: "json",
        cache: false,
        url: base_url + "/api/user/add_module_user",
...
function list_of_warehouse_users(page) {
    ...
    $.ajax({
        ...
        url: base_url + "/api/user/fetch_list_of_module_invitees", //list_module_users
...
function fetch_users_assigned_profiles(){
  ...
  $.ajax({
    ...
    url: base_url + "/api/accesscontrol/get_user_profiles_in_module",
    data: {
        "company_id": company_id,
        "module_id": 15,
        "user_id": user_id,
        "pri_level_access": store_id
    },
    timeout: 60000,
        ...
        if (response.status == '200') {
            ...
            if (response.data.length > 0) {
                ...
                $.each(response.data, function (i, v) {
                  ...
                  tr_line += '<tr id="role_tr_'+v.profile_id+'"><td></td><td><input type="checkbox" name="chk_b_k" class="chk_b_k" id="chkb_'+v.profile_id+'" '+disbl+' ></td><td>'+v.profile_name+'</td><td>...</td></tr>';
...
function add_remove_role(profile_id){
 ...
 const queryString = window.location.search;
  ...
  $.ajax({
    ...
    type: "POST",
    dataType: "json",
    url: base_url + "/api/accesscontrol/"+endpoint,
    headers: {
        'Authorization':localStorage.getItem('token'),
    },
    data: { 
...
function list_of_module_roles(){
  ...
  $.ajax({
    ...
    type: "POST",
    dataType: "json",
    url: base_url + "/api/user/module_roles_plus_user_roles",
    data: { "module_id" : 15 , "company_id" : company_id , "user_id" : user_id },
    timeout: 60000,
...
<script src="/js/user_roles.js?v=4018"></script>
<?php
