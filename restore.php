...
<div class="dt-content-wrapper">
    ...
    <div class="dt-content ">
        ...
        <div class="dt-page__header" style="display: flex; justify-content: space-between;">
            <h1 class="dt-page__title" style="padding:0px 10px">Restore</h1>
            <div style="display: flex;">
                <form class="search-box d-none d-lg-block" style="width: 200px; margin-right:10px">
                    <input class="form-control border-0 filter_pro" placeholder="Search back up..."
                        style="border:2px solid #64c6fd !important">
                </form>
                <button type="button" style="display: flex;" class="btn create_backup btn-primary btn-lg"
                    style="height:35px; background-color: #038FDE;color:white; padding:5px 5px; font-size:15px; margin-left:10px; padding:7px"><span
                        role="img" aria-label="add item" style="margin-right: 5px;margin-top: 1px; margin-top: -5px;"
                        ...
                        </svg></span><span style="margin-top: -5px;">Restore</span></button>
            </div>
        </div>
                ...
                <div class="ant-card ant-card-bordered">
                    <div class="ant-card-head">
                        <div class="ant-card-head-wrapper">
                            <div class="ant-card-head-title">All Restores</div>
                        </div>
                    </div>
                                                ...
                                                <table style="table-layout: auto;">
                                                    ...
                                                    <thead class="ant-table-thead">
                                                        <tr>
                                                            ...
                                                            <th class="ant-table-cell" style="width: 15%">Restore Time
                                                            </th>
                                                            <th class="ant-table-cell" style="width: 15%">User Name
                                                            </th>
                                                            <th class="ant-table-cell" style="width: 15%">File Type</th>
                                                            <th class="ant-table-cell" style="width: 15%">Restore Status
                                                            </th>
                                                            <!-- <th class="ant-table-cell" style="width: 15%">Sent to
                                                            </th> -->
                                                    ...
                                                    <tbody class="ant-table-tbody" id="store_data">
            ...
            <div class="dt-card__body">
                ...
                <form id="target" enctype="multipart/form-data">
                    ...
                    <button style="width: 83%; margin-left: auto;" type="button"
                        class="btn btn-primary create_store btn-block">Send</button>
                </form>
                <!-- /form -->
    ...
    <div class="swal2-container swal2-center create_product swal2-fade swal2-shown"
        ...
        <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show"
            ...
            <div class="swal2-header">
                ...
                <h2 class="swal2-title" id="swal2-title for_back_up" style="display: flex;">Success</h2><button
                ...
                <div class="modal-body">
                    ...
                    <form id="edit_cat">
                        ...
                        <div class="form-group form-row" style="margin-bottom:10px;">
                            ...
                            <!-- <div class="form-control"> -->
                            <input style="width: 95%;  margin-left: auto;margin-right: auto;" type="text"
                                id="cat_edit_add" class="form-control required">
                            <!-- </div> -->
                        </div>
                ...
                <div class="modal-body">
                    ...
                    <form id="edit_pro" enctype="multipart/form-data">
                        ...
                        <div class="form-group form-row" style="margin-bottom:10px;">
                            ...
                            <!-- <div class="form-control"> -->
                            <input style="width: 95%;margin-bottom:0px; margin-left: auto;margin-right: auto;"
                                type="text" id="store_name" class="form-control required">
                            <!-- </div> -->
                        </div>
                        <div class="form-group form-row" style="margin-bottom:10px;">
                            <label for="normal-input-4" class="col-form-label text-sm-right">Store
                                Address</label>
                            <!-- <div class="form-control"> -->
                            <input style="width: 95%;  margin-left: auto;margin-right: auto;" type="text" id="store_add"
                        ...
                        <div class="form-group form-row" style="margin-bottom:10px;">
                            ...
                            <!-- <div class="form-control"> -->
                            <input style="width: 95%;  margin-left: auto;margin-right: auto;" type="text"
                                id="store_desc" class="form-control required">
                            <!-- </div> -->
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-content" style="width: 600px;">
                ...
                <div class="modal-header" style="background-color: #0480BE; color:white">
                    <h3 class="modal-title" id="model-8" style="color:white">Restore
                    </h3>
                    <button type="button" class="close hide_btn" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true" style="color:white">×</span>
                    </button>
                ...
                <div class="modal-body invoice_history" style="width: 600px;">
                    ...
                    <form id="target" autocomplete="off" enctype="multipart/form-data" method="post">
                        ...
                        <!-- <p style="font-size: 16px; margin-bottom: 5px;">Your backed up data would be sent to your email
                            address. </p> -->
                        <p style="font-size: 16px; margin-bottom: 5px;">File</p>
                        <input class="ant-input" type="file" id="file_restore" />

                        <br>

                        <!-- <p style="font-size: 16px; margin-bottom: 5px;">Backing up your data today will not allow you to
                            initiate backup for the next 15 days</p> -->
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-sm" type="submit" id="just_import"
                                style="background-color: #1DCE8E; color:white" data-dismiss="modal">Restore
                            </button>
                            <button type="button" style="display:none;font-size: 20px;margin-left: 20px;padding: 0px 10px;background-color: #1DCE8E;
                            color: white;" class="ant-btn  ant-btn-loading restore_loading"><span class="ant-btn-loading-icon" style="position:relative; top:-6px;"><span role="img" aria-label="loading" class="anticon anticon-loading"><svg viewBox="0 0 1024 1024" focusable="false" class="anticon-spin" data-icon="loading" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M988 548c-19.9 0-36-16.1-36-36 0-59.4-11.6-117-34.6-171.3a440.45 440.45 0 00-94.3-139.9 437.71 437.71 0 00-139.9-94.3C629 83.6 571.4 72 512 72c-19.9 0-36-16.1-36-36s16.1-36 36-36c69.1 0 136.2 13.5 199.3 40.3C772.3 66 827 103 874 150c47 47 83.9 101.8 109.7 162.7 26.7 63.1 40.2 130.2 40.2 199.3.1 19.9-16 36-35.9 36z"></path></svg></span></span><span>Loading</span></button>
                        </div>
    ...
    $(document).ready(function() {
        ...
        function restore_file() {
            ...
            var fd = new FormData();
            var data_file = $('#file_restore').prop("files")[0];
            ...
            $.ajax({
                ...
                cache: false,
                url: base_url + "/api/pos/restoreBackup",
                data: fd,
                ...
                error: function() {
                    ...
                    $("#err_contact").remove();
                    $(`<h4 id="err_contact" style="padding:10px; margin:0px">${response.msg}</h4>`)
        ...
        function backup_history(page) {
            ...
            $.ajax({
                ...
                dataType: 'json',
                cache: false,
                url: base_url + "/api/pos/restoreHistories",
  headers: {'Authorization':localStorage.getItem('token') },
                    ...
                    if (response.status == "200") {
                        ...
                        if (response.data.length > 0) {
                            ...
                            $.each(response.data, function(i, v) {
                                list_whs += `
                        <tr data-row-key="1" class="ant-table-row ant-table-row-level-0 gradeA product_table even_${v.restore_id}" role="row" style="text-align:center" data-value="${v.restore_id}"
                        data="${v.restore_id}" >
            
                        <td class="ant-table-cell for_name" style="" id="for_sn_${v.restore_id}">${v.sn}</td>
                        <td class="ant-table-cell for_name" style="text-align:left" id="for_time_${v.restore_id}">${v.requested_time}</td>
                        <td class="ant-table-cell for_name" style="text-align:left" id="for_req_${v.restore_id}">${v.restore_request_by}</td>
                        <td class="ant-table-cell for_number" style="text-align:left;" id="for_type_${v.restore_id}">${v.restore_type}</td>
                        <td class="ant-table-cell" style="text-align:left; display:flex;">
                        ${v.backup_status == "uncompleted" ?
           `<span class="gx-badge gx-text-white s"style="background-color: #dd2a36; padding: 4px 10px 5px; cursor:pointer">${v.restore_status}</span>`
           : v.backup_status == "completed" ?
              `<span class="gx-badge gx-text-white history_log"  style="background-color: #1DCE8E;  padding: 4px 10px 5px; cursor:pointer">${v.restore_status}</span>`:
              `<span class="gx-badge gx-text-white history_log"  style="background-color:  #e58620;  padding: 4px 10px 5px; cursor:pointer">${v.restore_status}</span>`
                        }
              </td>
                                ...
                                //    <td class="ant-table-cell for_number" style="text-align:left;" id="for_back_time_${v.restore_id}">${v.restore_sent_to}</td>
