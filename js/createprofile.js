                ...
                if (response.data.length > 0) {
                  ...
                  $.each(response.data, function (i, v) {
                      ...
                      if(thegroupname != v.group_name){
                        ...
                        strTable += `<br><div class="form-group" style="padding: 10px 20px 0;
                         margin-left: 230px; margin-bottom:0px">
                        ...
                        strTable +=
                            `<div class="form-group" style="padding: 10px 20px 0;
                         margin-left: 230px; margin-bottom:0px">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="status">
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
...
function add_profile() {
    ...
    $.ajax({
        ...
        url: base_url+"/api/accesscontrol/create_profile",
        data: {
        ...
        success: function (response) {
            if (response.status == "200") {
                ...
                // coder error message
                 ...
                 $(`<h4 id="err_contact" style="padding:10px; margin:0px">Technical Error. Please try again later</h4>`)
