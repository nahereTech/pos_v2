...
<div class="dt-content-wrapper">
    ...
    <div class="dt-content ">
        ...
        <div class="dt-page__header" style="display: flex; justify-content: space-between;">
            <h1 class="dt-page__title" style="padding:0px 10px">Back up</h1>
            <div style="display: flex;">
                ...
                <button type="button" style="display: flex;" class="btn create_backup btn-primary btn-lg"
                    style="height:35px; background-color: #038FDE;color:white; padding:5px 5px; font-size:15px; margin-left:10px; padding:7px"><span
                        ...
                        </svg></span><span style="margin-top: -5px;">Create Backup</span></button>
            </div>
        </div>
                ...
                <div class="ant-card ant-card-bordered">
                    <div class="ant-card-head">
                        <div class="ant-card-head-wrapper">
                            <div class="ant-card-head-title">All Back ups</div>
                        </div>
                    </div>
                                                ...
                                                <table style="table-layout: auto;">
                                                    ...
                                                    <thead class="ant-table-thead">
                                                        <tr>
                                                            ...
                                                            <th class="ant-table-cell" style="width: 15%">Backup Time
                                                            </th>
                                                            <th class="ant-table-cell" style="width: 15%">User Name
                                                            </th>
                                                            <th class="ant-table-cell" style="width: 15%">File Type</th>
                                                            <th class="ant-table-cell" style="width: 15%">Export Status
                                                            </th>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-content" style="width: 600px;">
                ...
                <div class="modal-header" style="background-color: #0480BE; color:white">
                    <h3 class="modal-title" id="model-8" style="color:white">Create Backup
                    </h3>
                    <button type="button" class="close hide_btn" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true" style="color:white">×</span>
                    </button>
                    ...
                    <form id="target" autocomplete="off" enctype="multipart/form-data" method="post">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-sm" type="submit" id="just_import"
                                style="background-color: #1DCE8E; color:white" data-dismiss="modal">Create Backup
                            </button>
                        </div>
  ...
  headers: {'Authorization':localStorage.getItem('token') },
                ...
                success: function(response) {
                    ...
                    $('.contact_import_show').trigger("click");
                    $("#for_back_up").text(`Backup in progress...`);
                    $(".for_edit").show();
  ...
  headers: {'Authorization':localStorage.getItem('token') },
                ...
                url: base_url + "/api/pos/backupHistories",
                data: {
                    "user_id": localStorage.getItem('user_id'),
                    "company_id": localStorage.getItem('company_id'),
            "store_id": localStorage.getItem('store_id'),
                    ...
                    if (response.status == "200") {
                        ...
                        if (response.data.length > 0) {
                            ...
                            $.each(response.data, function(i, v) {
                                list_whs += `
                        <tr data-row-key="1" class="ant-table-row ant-table-row-level-0 gradeA product_table even_${v.backup_id}" role="row" style="text-align:center" data-value="${v.customer_id}"
                        data="${v.backup_id}" >
            
                        <td class="ant-table-cell for_name" style="" id="for_sn_${v.backup_id}">${v.backup_id}</td>
                        <td class="ant-table-cell for_name" style="text-align:left" id="for_time_${v.backup_id}">${v.requested_time}</td>
                        <td class="ant-table-cell for_name" style="text-align:left" id="for_req_${v.backup_id}">${v.backup_request_by}</td>
                        <td class="ant-table-cell for_number" style="text-align:left;" id="for_type_${v.backup_id}">${v.backup_type}</td>
                        <td class="ant-table-cell" style="text-align:left; display:flex;">
                        ${v.backup_status == "uncompleted" ?
           `<span class="gx-badge gx-text-white s"style="background-color: #dd2a36; padding: 4px 10px 5px; cursor:pointer">${v.backup_status}</span>`
           : v.backup_status == "completed" ?
              `<span class="gx-badge gx-text-white history_log"  style="background-color: #1DCE8E;  padding: 4px 10px 5px; cursor:pointer">${v.backup_status}</span>`:
              `<span class="gx-badge gx-text-white history_log"  style="background-color:  #e58620;  padding: 4px 10px 5px; cursor:pointer">${v.backup_status}</span>`
                        }
              </td>
                        <td class="ant-table-cell for_number" style="text-align:left;" id="for_back_time_${v.backup_id}">${v.backup_sent_to}</td>
