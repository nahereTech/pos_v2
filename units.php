...
<div class="dt-content-wrapper">
    ...
    <div class="dt-content">
        ...
        <div class="dt-page__header">
            <h1 class="dt-page__title" style=""> Units </h1>
        </div>
                                                ...
                                                <table style="table-layout: auto;">
                                                    ...
                                                    <thead class="ant-table-thead">
                                                        <tr>
                                                            ...
                                                            <th class="ant-table-cell" style="width: 25%">Employees</th>
                                                    ...
                                                    <tbody class="ant-table-tbody">
                                                        ...
                                                        <tr data-row-key="2" class="ant-table-row ant-table-row-level-0">
                                                            <td class="ant-table-cell ant-table-selection-column">
                                                                <label class="ant-checkbox-wrapper">
                                                                    <span class="ant-checkbox"><input name="Jim Green" type="checkbox" class="ant-checkbox-input" value="" /><span class="ant-checkbox-inner"></span></span>
                                                                </label>
                                                            </td>
                                                            <td class="ant-table-cell"><span class="gx-link">Jim Green</span></td>
                                                        ...
                                                        <tr data-row-key="3" class="ant-table-row ant-table-row-level-0">
                                                            <td class="ant-table-cell ant-table-selection-column">
                                                                <label class="ant-checkbox-wrapper">
                                                                    <span class="ant-checkbox"><input name="Joe Black" type="checkbox" class="ant-checkbox-input" value="" /><span class="ant-checkbox-inner"></span></span>
                                                                </label>
                                                            </td>
                                                            <td class="ant-table-cell"><span class="gx-link">Joe Black</span></td>
                                                            <td class="ant-table-cell">32</td>
                                                            <td class="ant-table-cell">Sidney No. 1 Lake Park</td>
                                                        </tr>
                                                        <tr data-row-key="4" class="ant-table-row ant-table-row-level-0">
                                                            ...
                                                            <td class="ant-table-cell"><span class="gx-link">Disabled User</span></td>
                                                            <td class="ant-table-cell">99</td>
                                                            <td class="ant-table-cell">Sidney No. 1 Lake Park</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
